...
test_that("the bfa.poisson.test functions returns the correct 'bfa_*_poisson_test' objects", {
  ...
  expect_that(bayes.poisson.test(5, 10, n.iter=30), is_a("bfa_one_sample_poisson_test"))
  expect_that(bayes.poisson.test(c(5, 20), c(10, 25), n.iter=30), is_a("bfa_two_sample_poisson_test"))
})