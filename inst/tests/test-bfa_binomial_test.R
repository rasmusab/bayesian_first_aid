...
test_that("bfa.binom.test accepts the same format as binom.test and returns a bfa_binom_test object", {
  ...
  expect_that(bayes.binom.test(c(682, 243), p = 3/4, n.iter=30), is_a("bfa_binom_test"))
  expect_that(bayes.binom.test(682, 682 + 243, p = 3/4, n.iter=30), is_a("bfa_binom_test"))
})
...
test_that("bfa.binom.test with generic functions does not give an error when run", {
